        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            <div className={styles.intro}>
              <p className={styles.mainText}>אשמח לצלם</p>
              <p className={styles.subText}>גם את הסיפור שלכם!</p>
              <p className={styles.description}>
                זמינה לכל שאלה, בואו נתכנן יחד יום בלתי נשכח!
              </p>
            </div>
            ...
            <div className={styles.contactInfo}>
              <div className={styles.contactItem}>
                ...
                <a href="tel:0542281004" className={styles.link}>054-228-1004</a>
              </div>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="mailto:rolan@gmail.com" className={styles.link}>rolan@gmail.com</a>
              </div>
              ...
              <a 
                ...
                aria-label="Facebook"
              >
                <svg className={styles.socialIcon} viewBox="0 0 24 24" fill="#1877F2" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <svg className={styles.socialIcon} viewBox="0 0 24 24" fill="url(#instagram-gradient)" xmlns="http://www.w3.org/2000/svg">
                  <defs>
